    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_selected:
                    "bg-primary-600 text-primary-50 hover:bg-primary-600 hover:text-primary-50 focus:bg-primary-600 focus:text-primary-50 dark:bg-primary-600 dark:text-primary-50 dark:hover:bg-primary-600 dark:hover:text-primary-50 dark:focus:bg-primary-600 dark:focus:text-primary-50",
